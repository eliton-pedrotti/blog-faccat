defmodule BlogFaccatWeb.PostControllerTest do
  use BlogFaccatWeb.ConnCase

  alias BlogFaccat.MyBlogFaccat

  @create_attrs %{author: "some author", body: "some body", date: "some date", title: "some title"}
  ...
  def fixture(:post) do
    {:ok, post} = MyBlogFaccat.create_post(@create_attrs)
    post
  end
